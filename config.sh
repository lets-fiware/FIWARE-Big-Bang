...
IMAGE_POSTFIX=letsfiware/postfix:0.28.0-next
...
IMAGE_ORION=telefonicaiot/fiware-orion:3.9.0
...
IMAGE_NODE_RED=letsfiware/node-red:0.28.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.28.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.28.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.28.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.28.0-next
