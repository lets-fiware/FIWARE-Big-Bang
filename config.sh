...
IMAGE_POSTFIX=letsfiware/postfix:0.27.0-next
...
IMAGE_NODE_RED=letsfiware/node-red:0.27.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.27.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.27.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.27.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.27.0-next
