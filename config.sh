...
IMAGE_POSTFIX=letsfiware/postfix:0.34.0-next
...
IMAGE_NODE_RED=letsfiware/node-red:0.34.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.34.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.34.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.34.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.34.0-next
