...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.7.0-next
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.7.0-next
...
IMAGE_NODE_RED=letsfiware/node-red:0.7.0-next
IMAGE_POSTFIX=letsfiware/postfix:0.7.0-next
