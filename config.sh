...
IMAGE_POSTFIX=letsfiware/postfix:0.23.0-next
...
IMAGE_ORION=telefonicaiot/fiware-orion:3.8.1
...
IMAGE_MINTAKA=fiware/mintaka:0.5.35
...
IMAGE_NODE_RED=letsfiware/node-red:0.23.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.23.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.23.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.23.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.23.0-next
