...
IMAGE_POSTFIX=letsfiware/postfix:0.8.0
...
IMAGE_NODE_RED=letsfiware/node-red:0.8.0
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.8.0
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.8.0
...
IMAGE_REGPROXY=letsfiware/regproxy:0.8.0
