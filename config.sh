...
IMAGE_POSTFIX=letsfiware/postfix:0.16.0-next
...
IMAGE_ORION=telefonicaiot/fiware-orion:3.7.0
...
# Docker image for Orion
IMAGE_ORION_LD=fiware/orion-ld:1.1.0
...
IMAGE_MINTAKA=fiware/mintaka:0.5.15
...
IMAGE_CYGNUS=telefonicaiot/fiware-cygnus:2.18.0
...
IMAGE_COMET=telefonicaiot/fiware-sth-comet:2.9.0
...
IMAGE_PERSEO_CORE=telefonicaiot/perseo-core:1.12.0
IMAGE_PERSEO_FE=telefonicaiot/perseo-fe:1.24.0
...
IMAGE_IOTAGENT_UL=telefonicaiot/iotagent-ul:1.21.0
...
IMAGE_IOTAGENT_JSON=telefonicaiot/iotagent-json:1.22.0
...
IMAGE_NODE_RED=letsfiware/node-red:0.16.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.16.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.16.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.16.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.16.0-next
