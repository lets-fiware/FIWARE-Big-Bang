...
IMAGE_POSTFIX=letsfiware/postfix:0.36.0-next
...
IMAGE_MINTAKA=quay.io/fiware/mintaka:0.5.40
...
IMAGE_NODE_RED=letsfiware/node-red:0.36.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.36.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.36.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.36.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.36.0-next
...
IMAGE_PWGEN=letsfiware/pwgen:0.36.0-next
