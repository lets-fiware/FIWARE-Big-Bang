...
IMAGE_POSTFIX=letsfiware/postfix:0.15.0-next
...
IMAGE_MINTAKA=fiware/mintaka:0.5.10
...
IMAGE_NODE_RED=letsfiware/node-red:0.15.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.15.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.15.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.15.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.15.0-next
