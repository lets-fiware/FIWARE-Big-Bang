...
```bash
curl -sL https://github.com/lets-fiware/FIWARE-Big-Bang/archive/refs/tags/v0.24.0.tar.gz | tar zxf -
```

Move to the `FIWARE-Big-Bang-0.24.0` directory.

```bash
cd FIWARE-Big-Bang-0.24.0/
```
