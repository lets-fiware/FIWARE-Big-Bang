...
IMAGE_POSTFIX=letsfiware/postfix:0.38.0-next
...
IMAGE_NODE_RED=letsfiware/node-red:0.38.0-next
...
IMAGE_ZEPPELIN=letsfiware/zeppelin:0.38.0-next
...
IMAGE_QUERYPROXY=letsfiware/queryproxy:0.38.0-next
...
IMAGE_TOKENPROXY=letsfiware/tokenproxy:0.38.0-next
...
IMAGE_REGPROXY=letsfiware/regproxy:0.38.0-next
...
IMAGE_PWGEN=letsfiware/pwgen:0.38.0-next
